...
public class GameFieldStageController extends NGStageController {
    ...
    protected void CreateDisplayController() {
        ...
        FDCBenderLeft = new NGImageDisplayController(LayerNotify, "BenderLeft", String.format("resources/sprites/id_%d.png", BoulderdashConsts.SPRITE_BENDER_FOOT_DOWN));
        ...
        FDCBenderRight = new NGImageDisplayController(LayerNotify, "BenderRight", String.format("resources/sprites/id_%d.png", BoulderdashConsts.SPRITE_BENDER_FOOT_DOWN));
        ...
        FDCDiamond = new NGImageDisplayController(LayerNotify, "Diamond", String.format("resources/sprites/id_%d.png", BoulderdashConsts.SPRITE_DIAMOND));
    ...
    public Integer getMaxTimeIndicatorFusibleLength() {
        return FDCTimeIndicator.getMaxFusibleLength();
    }

    public Integer getCurrentTimeIndicatorFusibleLength() {
        return FDCTimeIndicator.getCurrentFusibleLength();
    }

    public void setCurrentTimeIndicatorFusibleLength(Integer aValue) {
        FDCTimeIndicator.setCurrentFusibleLength(aValue);
    }

    public void resetTimeIndicator() {
        FDCTimeIndicator.resetTimeIndicator();
        RenderScene(FDCTimeIndicator);
    }
